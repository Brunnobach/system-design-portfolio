...
## Requirements
* Hierarchical agent structure (manager plus sub agents)
...
**External LLM APIs:** Stronger reasoning. Cost and latency.

## Outcome
A working prototype with a manager agent and sub agents for research, writing and scheduling.
