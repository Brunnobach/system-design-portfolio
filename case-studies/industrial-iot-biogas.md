...
## Problem
A network of 50+ biodigesters needs remote monitoring of temperature, pH, pressure and gas flow. Data must be ingested in real time, stored efficiently and visualized for operators.
...
| Option | Pros | Cons |
|--------|------|------|
| InfluxDB | Purpose-built, efficient | Query language less known than SQL |
| TimescaleDB | SQL-compatible | More operational overhead |
| Kafka | Scalable, durable | Heavy for this scale |

## Outcome
The platform can ingest simulated data from 100 sensors at 1 Hz with < 1% CPU usage on modest hardware.
