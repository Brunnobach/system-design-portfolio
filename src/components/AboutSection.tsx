...
export function AboutSection() {
  return (
    <section id="about" className="scroll-mt-24 border-t border-[var(--line)] py-24 sm:py-32">
      <div className="mx-auto grid max-w-6xl gap-12 px-5 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
        <Reveal>
          ...
          <p className="mt-5 text-[var(--text-muted)]">
            This portfolio is intentionally focused: system design thinking, trade-off analysis, and production awareness across MLOps, IoT, RAG, and ESG platforms.
          </p>
        </Reveal>
          ...
          <div className="border border-[var(--line)] bg-[var(--bg-elevated)] p-7">
            ...
            <ul className="space-y-3">
              {site.focus.map((item) => (
                <li
                  key={item}
                  className="flex items-center gap-3 border-b border-[var(--line)] pb-3 text-[var(--text)] last:border-0 last:pb-0"
                >
