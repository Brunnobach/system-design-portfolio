...
| Option | Pros | Cons |
|--------|------|------|
| scikit-learn Gradient Boosting | Easy to explain, no extra dependencies | Not state-of-the-art for large datasets |
| XGBoost / LightGBM | Better performance | Adds complexity |
| Deep learning (LSTM) | Can capture temporal patterns | More data and compute needed |

## Outcome
Achieved R² = 0.965 with RMSE ≈ 10 m³/day on a simulated 5,000-row dataset. API responds in < 100 ms locally.
