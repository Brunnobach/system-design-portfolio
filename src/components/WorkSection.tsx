      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <Reveal>
          ...
          <h2 className="max-w-2xl font-[family-name:var(--font-display)] text-3xl tracking-tight text-[var(--ink)] sm:text-5xl">
            Architecture case studies from industrial and sustainability
            systems.
          </h2>
        </Reveal>
            ...
            <Reveal key={study.slug} delay={index * 70}>
              ...
              >
                ...
                <div>
                  ...
                  <h3 className="font-[family-name:var(--font-display)] text-2xl tracking-tight text-[var(--ink)] transition-colors group-hover:text-[var(--accent)] sm:text-3xl">
                    {study.title}
                  </h3>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {study.stack.map((tech) => (
                      <span
                        key={tech}
                        className="border border-[var(--line)] bg-[var(--bg-elevated)] px-2.5 py-1 text-xs text-[var(--text-muted)]"
                      >
                        {tech}
                      </span>
                    ))}
